...
export const makeClient: (msalInstance: IPublicClientApplication, azureMapsClientId: string, apiVersion: string) => AddressFetcher = (msalInstance: IPublicClientApplication, azureMapsClientId: string, apiVersion: string = "2022-05-31"): AddressFetcher => {
